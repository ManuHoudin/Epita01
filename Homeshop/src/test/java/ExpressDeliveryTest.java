...
class ExpressDeliveryTest {
    ...
    @Test
    public void Giving_RegionCityAsLocation_WhenGettingDeliveryPrice_ThenGet9e99() {
        Delivery delivery = new ExpressDelivery("Bordeaux");
        assertEquals(9.99, delivery.getPrice(), 0.01);
    }

    @Test
    public void Giving_ParisCityAsLocation_WhenGettingDeliveryPrice_ThenGet6e99() {
